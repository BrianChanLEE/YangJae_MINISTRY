    ...
    $(document).ready(function () {
        ...
        $("#dZUpload").dropzone({
            ...
            success: function (file, response) {
				...
				excel_file_reader(map_idx, map_service, map_sub_idx, filename);
...
//                self.close();
		...
		function excel_file_reader(map_idx, map_service, map_sub_idx, filename){
			
			$.ajax({
				type: "post",
				url: "../map_normal_list_excel_reader.php",
				data: "map_idx="+map_idx+"&map_sub_idx="+map_sub_idx+"&filename="+filename,
				beforeSend: function() {
